...
import com.example.E_Commerce.E_commerce.Exceptions.Auth.InvalidAuthenticationProperty;
import com.example.E_Commerce.E_commerce.Filters.JwtRequestFilter;
...
import com.example.E_Commerce.E_commerce.Models.Auth.models.Register;
...
import com.example.E_Commerce.E_commerce.Service.Auth.RegisterService;
import com.example.E_Commerce.E_commerce.Service.Auth.UserService;
import com.example.E_Commerce.E_commerce.Service.MailService;
...
public class UserAuthenticationController {
    ...
    public ResponseEntity<?> logout(HttpServletResponse response) {
        JwtRequestFilter.deleteCookies((jakarta.servlet.http.HttpServletResponse) response);
...
//    }
    ...
    @GetMapping("/mailMe")
    public String mailMe() throws MessagingException, jakarta.mail.MessagingException {
